...
def app():
    ...
    with st.expander("See a brief description of the landcover types"):
        ...
        col52.markdown("Areas where the soil substrate is predominantly sandy, with the vegetation being mostly short-statured, sparsely distributed and clumped, and comprised mostly of grasses.")
        col61, col62 = st.columns([1, 4])
        col61.markdown("**_Ravine_**")
        col62.markdown("Areas with deep gullies following substrate weathering and erosion patterns. Tree cover is sparse, if at all, and ground vegetation is shrub- and grass-dominated")
        ...
        col22.markdown("Areas with grasses and shrubs in the understorey and trees above. Tree density is very low.")
        col31, col32 = st.columns([1, 4])
        col31.markdown("**_Shrub Savanna_**")
        col32.markdown("Areas with grasses and shrubs in the understorey and trees above. Tree density is low. Understorey has more shrubs than grasses, and can include short-statured woody vegetation.")
        col41, col42 = st.columns([1, 4])
        col41.markdown("**_Woodland Savanna_**")
        col42.markdown("Areas with grasses and shrubs in the understorey and trees above. Tree density is moderate. Large openings in the canopy cover remain, and the understorey is predominantly grasses.")
